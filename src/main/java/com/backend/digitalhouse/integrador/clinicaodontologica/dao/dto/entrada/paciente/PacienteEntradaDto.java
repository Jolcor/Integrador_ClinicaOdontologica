package com.backend.digitalhouse.integrador.clinicaodontologica.dao.dto.entrada.paciente;
...
public class PacienteEntradaDto {
    ...
    @Size(min = 3, max = 50, message = "El nombre debe tener hasta 50 caracteres")
